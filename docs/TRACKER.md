...
- [ ] **CHỜ USER**: gen offline 18 lessons / 360 cards + 5 topic metas còn lại theo `docs/CONTENT_BRIEF_P3_P4_REMAINING.md` (5 topics: education, nature-environment, entertainment, society-culture, abstract-academic). MVP target 42/840 cards. Hiện 24/480 cards = 57% done.
