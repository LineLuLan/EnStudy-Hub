...
| dev    | `7567909`               | base                   | 2026-05-17 (`7567909`) | P10b B2 — 5 lessons / 100 cards merged (P10 10/25)        |
| be     | `0390931`               | 2026-05-17 (`1617223`) | 2026-05-17 (`0390931`) | P10b B2 content commit on be (lint-staged prettier ran)   |
| fe     | `6a4b1c1`               | 2026-05-17 (`6a4b1c1`) | —                      | P10a docs sync — pending P10b sync sau docs commit dev    |
...
| 2026-05-17 | commit | (P7a docs) → dev      | `093d58b` | docs(content): P7a A2 expansion ship — 72/192 lessons / 1440 cards (37%)  |
...
| 2026-05-17 | commit | (P7c docs) → dev      | `7d80c0f` | docs(content): P7c A2 expansion ship — 82/192 lessons / 1640 cards (43%)  |
| 2026-05-17 | commit | (P7d content) → be    | `ae3af76` | feat(content): P7d A2 expansion — 5 lessons (100 cards) — P7 CLOSED       |
| 2026-05-17 | merge  | be → dev              | `17e4728` | merge: be → dev (P7d — P7 CLOSED, 20/20 lessons)                          |
| 2026-05-17 | sync   | dev → fe              | `c98c46d` | sync: dev → fe (P7d — P7 CLOSED, 1740 cards seeded)                       |
| 2026-05-17 | commit | (P7 close docs) → dev | `2d8a622` | docs(content): P7 CLOSED — 87/192 lessons / 1740 cards (45%)              |
...
| 2026-05-17 | commit | (P8b docs) → dev      | `799ca52` | docs(content): P8b ship + 50% Oxford 3000 milestone                       |
| 2026-05-17 | commit | (P8c content) → be    | `1d6b923` | feat(content): P8c B1 expansion — 5 lessons (100 cards)                   |
| 2026-05-17 | merge  | be → dev              | `2169324` | merge: be → dev (P8c B1 — 5 lessons / 100 cards, P8 15/25)                |
| 2026-05-17 | sync   | dev → fe              | `b234dad` | sync: dev → fe (P8c content) — 2040 cards seeded live                     |
| 2026-05-17 | commit | (P8c docs) → dev      | `b9f4b3e` | docs(content): P8c ship — 102/192 lessons / 2040 cards (53%)              |
| 2026-05-17 | commit | (P8d content) → be    | `96a7aa9` | feat(content): P8d B1 expansion — 5 lessons (100 cards)                   |
| 2026-05-17 | merge  | be → dev              | `5bb6b28` | merge: be → dev (P8d B1 — 5 lessons / 100 cards, P8 20/25)                |
| 2026-05-17 | sync   | dev → fe              | `2943625` | sync: dev → fe (P8d content) — 2140 cards seeded live                     |
